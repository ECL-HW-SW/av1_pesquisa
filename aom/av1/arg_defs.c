...
const av1_codec_arg_definitions_t g_av1_codec_arg_defs = {
  ...
  .disable_prune_partitions_before_search = ARG_DEF(
      NULL, "disable_prune_partitions_before_search", 0, "autoexplicavel"),

  .disable_prune_partitions_after_split = ARG_DEF(
      NULL, "disable_prune_partitions_after_split", 0, "autoexplicavel"),

  .disable_prune_4_way_partition_search = ARG_DEF(
      NULL, "disable_prune_4_way_partition_search", 0, "autoexplicavel"),

  .disable_av1_prune_ab_partitions =
  ...
  .disable_prune_4_partition_using_split_info = ARG_DEF(
