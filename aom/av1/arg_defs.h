...
typedef struct av1_codec_arg_definitions {
  ...
  arg_def_t disable_prune_partitions_before_search;
  arg_def_t disable_prune_partitions_after_split;
  arg_def_t disable_prune_4_way_partition_search;
  arg_def_t disable_av1_prune_ab_partitions;
  arg_def_t disable_av1_ml_prune_4_partition;
  arg_def_t disable_prune_4_partition_using_split_info;
  arg_def_t disable_av1_ml_prune_rect_partition;
  arg_def_t disable_prune_partitions_after_none;
