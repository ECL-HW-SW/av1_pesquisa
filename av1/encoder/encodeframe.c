...
BEGIN_PARTITION_SEARCH:
  ...
  if (!part_search_state.terminate_partition_search &&
...
#if CONFIG_COLLECT_PARTITION_STATS
    {
      ...
      tmp_sum_rdc.rate =
          part_search_state.partition_cost[PARTITION_HORZ_A];
  ...
  if (!part_search_state.terminate_partition_search &&
...
#if CONFIG_COLLECT_PARTITION_STATS
    {
      ...
      av1_init_rd_stats(&tmp_sum_rdc);
      tmp_sum_rdc.rate =
          part_search_state.partition_cost[PARTITION_HORZ_B];
      tmp_sum_rdc.rdcost = RDCOST(x->rdmult, tmp_sum_rdc.rate, 0);
      if (best_rdc.rdcost - tmp_sum_rdc.rdcost >= 0) {
  ...
  if (!part_search_state.terminate_partition_search &&
...
#if CONFIG_COLLECT_PARTITION_STATS
    {
      ...
      av1_init_rd_stats(&tmp_sum_rdc);
      tmp_sum_rdc.rate =
          part_search_state.partition_cost[PARTITION_VERT_A];
      tmp_sum_rdc.rdcost = RDCOST(x->rdmult, tmp_sum_rdc.rate, 0);
      if (best_rdc.rdcost - tmp_sum_rdc.rdcost >= 0) {
  ...
  if (!part_search_state.terminate_partition_search &&
...
#if CONFIG_COLLECT_PARTITION_STATS
    {
      ...
      av1_init_rd_stats(&tmp_sum_rdc);
      tmp_sum_rdc.rate =
          part_search_state.partition_cost[PARTITION_VERT_B];
      tmp_sum_rdc.rdcost = RDCOST(x->rdmult, tmp_sum_rdc.rate, 0);
      if (!frame_is_intra_only(cm) &&
